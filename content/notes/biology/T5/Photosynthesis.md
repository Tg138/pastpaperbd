...
**6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂** (in light, catalysed by chlorophyll)
...
$$\text{2H}_2\text{O} \rightarrow 4\text{H}^+ + 4e^- + \text{O}_2$$
...
$$\text{NADP} + 2\text{H}^+ + 2e^- \rightarrow \text{reduced NADP (NADPH)}$$
...
$$\text{CO}_2 + \text{RuBP (5C)} \rightarrow 2 \times \text{GP (3C)}$$
...
$$\text{GP} + \text{reduced NADP} + \text{ATP} \rightarrow \text{TP} + \text{NADP} + \text{ADP} + P_i$$
...
$$5 \times \text{TP (3C)} + \text{ATP} \rightarrow 3 \times \text{RuBP (5C)}$$
...
- 2 ATP used (1 to reduce GP → TP, 1 to regenerate RuBP)
